...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{Fig/hsimg.jpg}
...
Meanwhile, these images possess several drawbacks. First, their acquisition requires specific sensors which are costly and bulky. Secondly, due to the tightness of a specific band, the energy of signal to measure is very small and thus limits the spacial resolution of the image. The sensors uses by the new Sentinel-2 satellites have for example a resolution of 30x30m. And finally, specific algorithms need to be designed in order to handle the dimensionality of the data.
...
\label{sec:exp-otb}
    ...
    \begin{figure}[!ht]
        ...
        \begin{tabular}{|l|c|c|c|c|c|c|}\hline
            ...
            \hline
        \end{tabular}
        \caption{Mean time for training and classification for results of Table \ref{tab:aisa-otbsimu}.\label{tab:aisa-otbsimu-time}}
    \end{figure}
    ...
    \begin{figure}[!ht]
        ...
        \begin{tabular}{|l|c|c|c|}\hline
            ...
            \hline
        \end{tabular}
        \caption{Results of classification with sampling on separate polygons and 20 trials (standard deviation in parenthesis).\label{tab:aisa-otbsimu-reduced}}
    \end{figure}
    ...
    \begin{figure}[!ht]
        ...
        \begin{tabular}{|l|c|c|c|c|c|c|}\hline
            ...
            \hline
        \end{tabular}
        \caption{Mean time for training and classification for results of Table \ref{tab:aisa-otbsimu}.\label{tab:aisa-otbsimu-time-reduced}}
    \end{figure}
