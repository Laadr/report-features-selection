...
Two selection algorithms are presented the sequential forward features selection method (Section \ref{sec:forward-presentation}) and the sequential floating forward feature selection method (\ref{sec:floating-presentation}) the second being a more complex variation of the first.
    ...
    In this section, we discuss the results of the features selection method. The forward selection and the floating forward selection are compared and the results with the different criterion function are also discussed. All the experimentation has been conducted with a single dataset presented in the next subsection.
        ...
        \begin{figure}[!ht]
            \centering
            \begin{tabular}{ccc}
                \includegraphics[width=0.33\textwidth]{Fig/time_aisa_trials_20_kappa.pdf} &
                \includegraphics[width=0.33\textwidth]{Fig/time_aisa_trials_20_accuracy.pdf} &
                \includegraphics[width=0.33\textwidth]{Fig/time_aisa_trials_20_F1Mean.pdf} \\
                {\bfseries{(a)}} & {\bfseries{(b)}} & {\bfseries{(c)}} \\
                \includegraphics[width=0.33\textwidth]{Fig/time_aisa_trials_20_divKL.pdf} &
                \includegraphics[width=0.33\textwidth]{Fig/time_aisa_trials_20_JM.pdf} & \\
        ...
        \begin{figure}[!ht]
            ...
            \begin{tikzpicture}
                \begin{umlpackage}{otb}
                    \umlclass[template={\footnotesize{InputType,LabelType}}]{MachineLearningModel}{
                      n : uint
                      }{}
                \end{umlpackage}

                \begin{umlpackage}{otbExternalFastFeaturesSelection}
                    \umlclass[template={\footnotesize{InputType,LabelType}}, x=10]{GMMMachineLearningModel}{
                      n : uint \\ t : float
                    }{}
                    \umlclass[template={\footnotesize{InputType,LabelType}}, x=10, y=-6]{GMMSelectionMachineLearningModel}{
                      d : double
                    }{
                      \umlvirt{setB(b : B) : void} \\ getB() : B}
                \end{umlpackage}

                \umlinherit[geometry=-|]{GMMMachineLearningModel}{MachineLearningModel}
