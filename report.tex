...
\label{sec:exp-otb}
    ...
    \end{itemize}
    These 151 features are then stacked to create a new image with 151 bands. The training is made with tile 5\_11 and we test with tiles 3\_10, 5\_12 and 7\_8.
